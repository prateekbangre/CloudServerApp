...
public class CommonClass {
    ...
    public void showCustomDialog(String title, String given, Context context) {
    ...
    public void showCustomDialog(int icon, String title, String given, Context context) {
        AlertDialog.Builder builder;
        builder = new AlertDialog.Builder(context);
    ...
    public String getOnError(ANError anError) {
    ...
    public void showConnectionError(Context context) {
        showCustomDialog("Connection Error",
    ...
    public void showUnAuthorized(Context context) {
        showCustomDialog("Unauthorized request",
